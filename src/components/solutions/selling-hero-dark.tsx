...
export function SellingHeroDark() {
    const [showSamples, setShowSamples] = useState(false)

    return (
        <section className="relative overflow-hidden bg-[#1e3a8a] py-20 lg:py-32 border-t border-blue-800">
            {/* Background Pattern */}
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-4">
                            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl text-white">
                                Discover Your True Business Value
                            </h1>
                            <p className="max-w-xl text-lg text-blue-100 leading-relaxed">
                                Get accurate, data-driven valuations tailored to your business. Make informed decisions with comprehensive reports backed by industry experts.
                            </p>
                        </div>
