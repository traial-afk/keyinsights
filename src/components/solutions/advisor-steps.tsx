    ...
    const steps = [
        {
            number: "01",
            icon: FileText,
            title: "Submit Client Information",
            description: "Upload your client's financials through our secure advisor portal.",
            expandable: true,
            expandedContent: {
                intro: "Here's what you'll need from your client:",
                sections: [
                    {
                        icon: Building2,
                ...
                note: "Missing something? No problem. Start with what you have we'll let you know if we need more."
            }
        },
        {
            number: "02",
        ...
        },
        {
            number: "03",
            icon: Download,
            title: "Receive Client-Ready Deliverables",
            description: "Get your reports in 24 hours white-labeled with your branding or delivered as independent analysis.",
            expandable: false
        },
        {
            number: "04",
            ...
            description: 'Walk through your results with our team. We will explain the methodology, answer your questions, and walk you through the findings.',
            expandable: false
        }
    ]
            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900">
                        From Your Submission to{" "}
                        <span className="text-[#1e3a8a]">Client-Ready Deliverables</span>
                        {" "}in 24 Hours
                    </h2>
                </div>
                    ...
                    {steps.map((step, index) => (
                        ...
                        >
                            <div className="md:col-span-2">
                                <div className="text-8xl text-[#1e3a8a]/20 font-light">
                                    {step.number}
                                </div>
                            </div>
                            ...
                            <div className="md:col-span-10">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        {step.expandable && (
                                            <button
                                                className="flex items-center gap-2 text-slate-500 hover:text-[#1e3a8a] transition-colors px-4 py-2 rounded-lg hover:bg-slate-50"
                                    ...
                                    {step.expandable && step.expandedContent && (
                                        ...
                                        >
                                            <div className="px-8 pb-8 pt-2 border-t border-slate-100">
                                                        ...
                                                        >
                                                            <div className="flex items-center gap-3 mb-4">
                                                                <div className="w-10 h-10 bg-[#1e3a8a]/10 rounded-lg flex items-center justify-center">
                                                                    <section.icon className="w-5 h-5 text-[#1e3a8a]" />
                                                                </div>
                                                ...
                                                <div className="mt-6 bg-[#1e3a8a]/5 rounded-xl p-4 flex items-start gap-3">
                                                    <div className="w-8 h-8 bg-[#1e3a8a]/10 rounded-lg flex items-center justify-center flex-shrink-0">
