    ...
    const steps = [
        {
            ...
            description: 'Complete our questionnaire in under 10 minutes with the target business details and financials.',
            expandable: true,
            expandedContent: {
                ...
                note: "Don't have everything? No problem. Start with what you have, and we'll let you know if we need more.",
            },
        },
        {
            number: '02',
        ...
        },
        {
            ...
            description: 'Get your comprehensive valuation with fair market value, risk assessment, and negotiation insights. Delivered in 24 hours',
            expandable: false,
        },
        {
            number: '04',
            ...
            description: "Walk through your results with our team. We'll explain the methodology, answer questions, and help you understand what the numbers mean for your deal",
            expandable: false,
        },
    ];
