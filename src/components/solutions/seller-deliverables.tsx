...
import { FileText, AlertTriangle, Presentation, FileSpreadsheet, TrendingUp, Eye, Download, X, Check } from "lucide-react"
...
export function SellerDeliverables() {
            ...
            <div className="container mx-auto px-4 max-w-5xl">
                ...
                <div className="text-center mb-16 space-y-4">
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold text-slate-900 font-['Playfair_Display'] serif">
                        ...
                        <span className="text-[#1e3a8a]">Ready to list.</span>
                    </h2>
                    <p className="text-slate-600 max-w-2xl mx-auto text-lg">
                        Everything you need to negotiate with confidence and go to market if you're ready.
                    </p>
                </div>
                ...
                {showSamples && (
                    <div className="mt-10 animate-in fade-in slide-in-from-top-4 duration-500">
                        <div className="relative rounded-2xl bg-white p-8 shadow-xl border border-slate-200">
